  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (membersViewModel.membersInfos.isEmpty &&
        ...
        membersViewModel.memberInfosGet();
      }
    });
    return Stack(
      children: [
              ...
              return SfDataGrid(
                ...
                columns: [
                  ...
                  GridColumn(
                    ...
                    label: _buildHeader('队伍名称'),
                  ),
                  GridColumn(columnName: 'role', label: _buildHeader('担任角色')),
                  GridColumn(
        ...
        memberinfos.map<DataGridRow>((memberinfo) {
          ...
          return DataGridRow(
            cells: [
              ...
              DataGridCell<String>(columnName: 'role', value: memberinfo.role),
